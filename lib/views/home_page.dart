  ...
  _getCurrentLocation() async {
    ...
    await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      Timer.periodic(Duration(minutes: 1), (tick) {
        print("update");
        _presenter.updateUserLocation(currentLocation.longitude, currentLocation.latitude);
      });
    }).catchError((e) {
      print(e);
    });
      ...
      if (sheetView.items.length > 0)
        {
          ...
          //if(startPlacemark != null)
            //{
              Position startCoordinates = Position(latitude: _currentPosition.latitude, longitude: _currentPosition.longitude);
              ...
              Marker destinationMarker = Marker(
                ...
                icon:  sheetView.nextItem.id == sheetItem.id ? BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueYellow) : sheetItem.address.completed ? BitmapDescriptor.defaultMarkerWithHue(BitmapDescriptor.hueGreen) :BitmapDescriptor.defaultMarker,
                onTap: () {
                  showDialog(
                    context: context,
                    builder: (BuildContext context) => _buildPopupDialog(context,sheetItem),
                  );
...
setState(() {
      ...
      List<Location> startPlacemark = await locationFromAddress("31.9082965, 35.3038551");
      List<Location> secondPlacemark = await locationFromAddress("31.9082965, 35.2538551");
      List<Location> destinationPlacemark = await locationFromAddress("31.9082965, 35.2038551");
 ...
 /*   markers.removeWhere(
  ...
  _openPopup2(context,remainingOnly) {
    showDialog(
        context: context,
        builder: (_) {
          return MyDialog2(customerView:_presenter.sheetsView,flag:remainingOnly);
        }).then((value) => {
          if(value != null)
            {
  ...
  _updateLocation(dynamic value) async {
    ...
    await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high)
      ...
      setState(() {
        _onLoading();
        _currentPosition = position;
        _presenter.updateCustomerViews(_presenter.sheetsView.deliveryLine.id, value,_currentPosition.longitude,
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            // showing the route,
            (_presenter.sheetsView != null && _presenter.sheetsView.sheetCounts != null ) ?
            SafeArea(
              child: Align(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          RaisedButton(
                            onPressed:(_presenter.sheetsView != null && _presenter.sheetsView.sheetCounts != null)
                          ? () async {
                        _openPopup2(context,false);
                          ...
                          : null,
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                'كل العناوين'+" : "+_presenter.sheetsView.items.length.toString(),
                                style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 20.0,
                                ),
                            ...
                            children: <Widget>[
                              Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    'غير محدد' + " : " + (_presenter.sheetsView != null ? _presenter.sheetsView.sheetCounts != null ? _presenter.sheetsView.sheetCounts.unassigned.toString() : "_" : "") ,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 20.0,
                                    ),
                              ...
                              Expanded(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.all(4.0),
                                  child: Text(
                                    'المتبقي' + " : " + (_presenter.sheetsView != null ? _presenter.sheetsView.sheetCounts != null ? _presenter.sheetsView.sheetCounts.remaining.toString() : "_" : "") ,
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 20.0,
                                    ),
        ...
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(sheetItem.customer_company_name,style: TextStyle(fontSize: 22,fontWeight: FontWeight.w600),),
              SizedBox(height: 15,),
              Text(" العنوان:"+sheetItem.address.address,style: TextStyle(fontSize: 14),textAlign: TextAlign.start,),
              SizedBox(height: 15,),
              Text(" رقم الهاتف:"+sheetItem.address.phone,style: TextStyle(fontSize: 14),textAlign: TextAlign.start,),
              SizedBox(height: 15,),
              Text(" رقم الموبايل:",style: TextStyle(fontSize: 14),textAlign: TextAlign.start,),
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return  RaisedButton(
                      child: Text(sheetItem.address.mobileNumbers[index]),
                      onPressed: () {
                        UrlLauncher.launch('tel:+${sheetItem.address.mobileNumbers[index]}');
                      },
                    );
                  },
                ),
                ...
                onPressed: () {
    FlutterPhoneDirectCaller.callNumber(sheetItem.address.mobile);
                },
              ),
              SizedBox(height: 15,),
              Text(" الكمية:"+sheetItem.address.quantity,style: TextStyle(fontSize: 14),textAlign: TextAlign.start,),
              SizedBox(height: 15,),
              Text(" المجموع:"+sheetItem.address.price,style: TextStyle(fontSize: 14),textAlign: TextAlign.start,),
              SizedBox(height: 22,),
              Row(
                ...
                children: [FlatButton(
                    ...
                    onPressed: (){
                      ...
                      _launchUniversalLinkIos("https://www.google.com/maps/dir//${sheetItem.address.location.latitude},${sheetItem.address.location.longitude}");
                    },
                    child: Text("عرض الاتجاهات",style: TextStyle(fontSize: 18,color: Theme.of(context).primaryColor),)),FlatButton(
                    ...
                    onPressed: (){
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          return AlertDialog(
                            title: new Text("توصيل الطلبية",textAlign: TextAlign.center),
                            content: new Text(sheetItem.customer_company_name,textAlign:TextAlign.center,),
                            actions: <Widget>[
                              new FlatButton(
                                child: new Text("لا"),
                                onPressed: () {
                    ...
                    child: Text("تم توصيل الطلبية",style: TextStyle(fontSize: 18,color: Colors.white),))],
              ),
    Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly,children: [FlatButton( onPressed: (){
      Navigator.of(context).pop();
      mapController.animateCamera(
        CameraUpdate.newCameraPosition(
          CameraPosition(
            target: LatLng(double.parse(sheetItem.address.location.latitude), double.parse(sheetItem.address.location.longitude)),
            zoom: 17.0,
          ),
        ),
      );
    },
    color: Theme.of(context).primaryColor,child: Text("عرض التفاصيل",style: TextStyle(fontSize: 18,color:  Colors.white),textAlign: TextAlign.center)),FlatButton(
    color: Colors.white,
    onPressed: (){
      Navigator.pop(context);
      Navigator.pushNamed(context, '/customer');
    },
    child: Text("انتقال الى المكان",style: TextStyle(fontSize: 18,color: Theme.of(context).primaryColor),textAlign: TextAlign.center),)],),
            ],
          ),
        ),
        Positioned(
...
class HomeScreenPresenter {
  ...
  {
    api.updateUserLocation(long,lat).then((bool response) {
    }).catchError((Object error) => _view.onDataError(error.toString()));
  }
  ...
  updateCustomerViews(String id,String addressId,double long,double lat) {
    api.updateCustomerView(id,addressId,long,lat).then((CustomerView customerView) {
      print("customerView:$customerView");
      getDeliveryLines();
    }).catchError((Object error) => _view.onDataError(error.toString()));
  }
...
class MyDialog extends StatefulWidget {
  ...
  @override
  _MyDialogState createState() => new _MyDialogState(customerView:customerView);
}

class _MyDialogState extends State<MyDialog> {
  String indexID = "";
  List<CustomerItem> filteredList = List();
  final CustomerView customerView;
  ...
  void filter(String inputString) {
    filteredList =
        customerView.items.where((i) => i.company_name.toLowerCase().contains(inputString)).toList();
    setState(() {});
  }
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) => ListTile(
                    title: Text(filteredList[index].company_name,textAlign: TextAlign.right,),
                    subtitle:Text(filteredList[index].address,textAlign: TextAlign.right) ,
                    leading: Icon(Icons.location_pin,color: (filteredList[index].longitude != null && filteredList[index].latitude != null) ? Colors.red : Colors.grey),
                    onTap: () {
                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          // return object of type Dialog
                          return AlertDialog(
                            title: new Text("هل انت متأكد انك تريد حفظ الموقع",textAlign: TextAlign.center),
...
class MyDialog2 extends StatefulWidget {
  ...
  final bool flag;
  MyDialog2({Key key, @required this.customerView,@required this.flag}) : super(key: key);
  @override
  _MyDialogState2 createState() => new _MyDialogState2(customerView:customerView,flag:flag);
}

class _MyDialogState2 extends State<MyDialog2> {
  String indexID = "";
  List<SheetItem> filteredList = List();
  final SheetsView customerView;
  final bool flag;
  _MyDialogState2({Key key, @required this.customerView,@required this.flag}) ;

  @override
  void initState() {
    super.initState();
    if(flag == true) {
      filteredList = customerView.items.where((element) => element.address.completed == false).toList();
    }
    else
      {
        filteredList = customerView.items;
  ...
  void filter(String inputString) {
    var temp =
        customerView.items.where((i) => i.customer_company_name.toLowerCase().contains(inputString)).toList();
    if(flag == true) {
      filteredList = temp.where((element) => element.address.completed == false).toList();
    }
    else
    {
      filteredList = temp;
            ...
            children: <Widget>[
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) => ListTile(
                    title: Text(filteredList[index].customer_company_name,textAlign: TextAlign.right,),
                    subtitle:Text(filteredList[index].address.address,textAlign: TextAlign.right) ,
